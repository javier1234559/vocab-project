...
export default function Footer() {
  ...
  return (
    <footer className="bg-secondary px-8 py-8 mt-4">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-secondary-400">
              Learn by writing - Improve your vocabulary and language skills through writing exercises.
            </p>
        ...
        <p className="text-xs text-secondary">&copy; 2022. Company Name. All rights reserved.</p>
      </div>
    </footer>
  );
};
